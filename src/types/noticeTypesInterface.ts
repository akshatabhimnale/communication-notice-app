// This file defines TypeScript interfaces for a notice management system.
// It includes interfaces for notice types, schema fields, and API responses. The interfaces help in structuring the data and ensuring type safety in the application.
